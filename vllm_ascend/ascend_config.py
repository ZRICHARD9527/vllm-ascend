...
class AscendCompilationConfig:
    ...
    def __init__(
        ...
        enable_static_kernel: bool | None = None,
        ...
        **kwargs,
        ...
        Args:
            enable_npugraph_ex (bool): Whether to enable npugraph_ex backend.
                ...
                Default: True
            enable_static_kernel (bool | None): Whether to enable static kernel.
                ...
                When None, defaults to the value of enable_npugraph_ex.
                Default: None
        ...
        if enable_static_kernel is None:
            self.enable_static_kernel = enable_npugraph_ex
        else:
